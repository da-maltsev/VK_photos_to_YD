...
class UserService:
    ...
    def upload_photo(self):
        ...
        if 500 > status != 400:
            print('Фотографии успешно загружены на Диск!')
        else:
            print('Ошибка при загрузке фотографий, увы и ах!')


if __name__ == '__main__':
    user1 = UserService(552934290, TOKEN_VK) #тут вписать нужный id в VK
